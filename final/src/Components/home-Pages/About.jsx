  ...
  return (
    <div className="about-container">
      <p>
        ...
        is a simlpe habit tracking application, it helps you build a new good
        habit or break a bad habit and many more options
      </p>
      <p>
        ...
        the habit by clicking the View habit details accordion.
        <br></br>
